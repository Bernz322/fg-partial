          ...
          <Tab.Container defaultActiveKey="first">
            ...
            <Tab.Content>
              ...
              >
                ...
                <div className="bd-example">
                  <p className="lead">
                    This is a lead paragraph. It
                    stands out from regular
                    paragraphs.
                  </p>
                </div>
                <div className="bd-example">
                  ...
                  <p>
                    <ins>
                      This line of text is meant
                      to be treated as an addition
                      to the document.
                    </ins>
                  </p>
                  <p>
                    <u>
                      This line of text will
                      render as underlined.
                    </u>
                  </p>
                  <p>
                    <small>
                      This line of text is meant
                      to be treated as fine print.
                    </small>
                  </p>
                  <p>
                    <strong>
                ...
                <div className="bd-example">
                  <ul className="list-unstyled">
                    ...
                    <li>
                      However, this style only
                      applies to immediate child
                      elements.
                    </li>
                    <li>
                      Nested lists:
