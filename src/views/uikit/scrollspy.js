                ...
                <div className="bd-example">
                  ...
                  >
                    ...
                    <ul className="nav nav-pills">
                      <Nav.Item as="li">
                        <Nav.Link href="#scrollspyHeading1">
                          First
                        </Nav.Link>
                      </Nav.Item>
                      <Nav.Item as="li">
                        <Nav.Link href="#scrollspyHeading2">
                          Second
                        </Nav.Link>
                      </Nav.Item>
                  ...
                  >
                    ...
                    <p>
                      ...
                      content for the scrollspy
                      page. Note that as you
                      scroll down the page, the
                      appropriate navigation link
                      is highlighted. It&apos;s
                      repeated throughout the
                      component example. We keep
                      adding some more example
                      copy here to emphasize the
