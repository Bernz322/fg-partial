                ...
                <ul className="list-inline m-0 p-0">
                  <li className="d-flex mb-2">
                    ...
                    <p className="news-detail mb-0">
                      there is a meetup in your
                      city on fryday at 19:00.{" "}
                      <Link to="#">
                        see details
                      </Link>
                    </p>
                  ...
                  <Card.Body className="p-0">
                    ...
                    <div className="comment-area p-3">
                      ...
                      <p>
                        ...
                        nulla dolor, ornare at
                        commodo non, feugiat non
                        nisi. Phasellus faucibus
                        mollis pharetra. Proin
                        blandit ac massa sed
                        rhoncus
                      </p>
                      <hr />
                ...
                <Card>
                  ...
                  <Card.Body>
                    <div className="user-bio">
                      <p>
                        Tart I love sugar plum I
                        love oat cake. Sweet roll
                        caramels I love jujubes.
                        Topping cake wafer.
                      </p>
                    </div>
                    <div className="mt-2">
