        ...
        <Col md="12">
                  ...
                  <Col md="8">
                    <Card.Body>
                      ...
                      <p className="mt-2">
                        ...
                        of the above-listed
                        amenities, classes, and
                        services, Life Time&apos;s
          ...
          <Row className=" iq-star-inserted row-cols-1 row-cols-md-2 row-cols-lg-3 mb-5 mt-5 text-center">
            <Col className=" iq-star-inserted-1">
              <Card className=" my-5">
                <Card.Body>
                  <h2 className="my-0 fw-normal mb-4">
                    Enterprise
                  </h2>
                  <Card.Title
                    as="h1"
                ...
                <Card.Body>
                  <h2>
                    <span className="badge rounded-pill bg-soft-primary mb-4">
                      <small className="text-uppercase px-3">
                        Popular
                      </small>
                    </span>
                  </h2>
