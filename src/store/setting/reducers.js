...
const Choices = {
  SchemeChoice:
    DefaultSetting.theme_scheme.choices,
  ColorChoice: DefaultSetting.theme_color.choices,
  StyleAppearanceChoice:
    DefaultSetting.theme_style_appearance.choices,
  CardStyle: DefaultSetting.card_style.choices,
  FSChoice:
    DefaultSetting.theme_font_size.choices,
  Animation:
    DefaultSetting.theme_transition.choices,
};
...
export const settingSlice = createSlice({
  ...
  reducers: {
    ...
    saveLocal: (state, action) => {
      if (
        typeof action.payload !== typeof undefined
      ) {
    ...
    theme_scheme_direction: (state, action) => {
      if (
        ...
        state.setting.theme_scheme_direction.value =
          action.payload;
      }
      updateHtmlAttr({
        prop: "dir",
        value:
          state.setting.theme_scheme_direction
            .value,
      });
      updateStorage(
        state.saveLocal,
    ...
    theme_color: (state, action) => {
      if (
        ...
        _.forEach(
          ...
          (value, key) => {
            state.setting.theme_color.colors[
              key
            ] = value;
          }
        );
        state.setting.theme_color.value =
    ...
    theme_transition: (state, action) => {
      if (
        ...
        state.setting.theme_transition.value =
          action.payload;
      }
      updateBodyClass(
        Choices.Animation,
    ...
    theme_font_size: (state, action) => {
      if (
        ...
        state.setting.theme_font_size.value =
          action.payload;
      }
      updateHtmlClass(
        Choices.FSChoice,
    ...
    page_layout: (state, action) => {
      state.setting.page_layout.value =
        action.payload;
      updateStorage(
        state.saveLocal,
        state.storeKey,
    ...
    header_navbar: (state, action) => {
      state.setting.header_navbar.value =
        action.payload;
      updateStorage(
        state.saveLocal,
        state.storeKey,
    ...
    card_style: (state, action) => {
      if (
        ...
        state.setting.card_style.value =
          action.payload;
      }
      updateBodyClass(
        Choices.CardStyle,
    ...
    header_banner: (state, action) => {
      state.setting.header_banner.value =
        action.payload;
      updateStorage(
        state.saveLocal,
        state.storeKey,
    ...
    sidebar_color: (state, action) => {
      state.setting.sidebar_color.value =
        action.payload;
      updateStorage(
        state.saveLocal,
        state.storeKey,
    ...
    sidebar_type: (state, action) => {
      state.setting.sidebar_type.value =
        action.payload;
      updateStorage(
        state.saveLocal,
        state.storeKey,
    ...
    sidebar_show: (state, action) => {
      state.setting.sidebar_show.value =
        action.payload;
      updateStorage(
        state.saveLocal,
        state.storeKey,
    ...
    navbar_show: (state, action) => {
      state.setting.navbar_show.value =
        action.payload;
      updateStorage(
        state.saveLocal,
        state.storeKey,
    ...
    sidebar_menu_style: (state, action) => {
      state.setting.sidebar_menu_style.value =
        action.payload;
      updateStorage(
        state.saveLocal,
        state.storeKey,
    ...
    body_font_family: (state, action) => {
      if (
        ...
        state.setting.body_font_family.value =
          action.payload;
      }
      setFontFamily(
        "body",
    ...
    heading_font_family: (state, action) => {
      if (
        ...
        state.setting.heading_font_family.value =
          action.payload;
      }
      setFontFamily(
        "heading",
